...
export class RefillStatusComponent implements OnInit {
  ...
  constructor(private route:ActivatedRoute, private rservice:RefillStatusService,private router:Router,private authService:AuthService,private snack:MatSnackBar) { 
